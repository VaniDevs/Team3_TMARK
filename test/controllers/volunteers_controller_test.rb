...
class VolunteersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create volunteer" do
    assert_difference('Volunteer.count') do
      post volunteers_url, params: { volunteer: { email: @volunteer.email, firstname: @volunteer.firstname, lastname: @volunteer.lastname, phone: @volunteer.phone } }
    end
  ...
  test "should update volunteer" do
    patch volunteer_url(@volunteer), params: { volunteer: { email: @volunteer.email, firstname: @volunteer.firstname, lastname: @volunteer.lastname, phone: @volunteer.phone } }
