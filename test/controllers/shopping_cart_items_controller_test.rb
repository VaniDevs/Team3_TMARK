...
class ShoppingCartItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shopping_cart_item" do
    assert_difference('ShoppingCartItem.count') do
      post shopping_cart_items_url, params: { shopping_cart_item: { product_id: @shopping_cart_item.product_id, shoppingCart_id: @shopping_cart_item.shoppingCart_id } }
    end
  ...
  test "should update shopping_cart_item" do
    patch shopping_cart_item_url(@shopping_cart_item), params: { shopping_cart_item: { product_id: @shopping_cart_item.product_id, shoppingCart_id: @shopping_cart_item.shoppingCart_id } }
