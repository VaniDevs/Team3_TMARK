...
class ShoppingCartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shopping_cart" do
    assert_difference('ShoppingCart.count') do
      post shopping_carts_url, params: { shopping_cart: { appointment_id: @shopping_cart.appointment_id, volunteer_id: @shopping_cart.volunteer_id } }
    end
  ...
  test "should update shopping_cart" do
    patch shopping_cart_url(@shopping_cart), params: { shopping_cart: { appointment_id: @shopping_cart.appointment_id, volunteer_id: @shopping_cart.volunteer_id } }
